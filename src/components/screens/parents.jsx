...
const TableParent = ({ darkmode }) => {
    ...
    const handleSearch = (e) => {
        ...
        const filtered = data.filter((item) =>
            item.nom.toLowerCase().includes(value) || item.prenom.toLowerCase().includes(value)
        );
    ...
    const handleModalSubmit = async () => {
        try {
            ...
            message.error("Une erreur s'est produite lors de la mise à jour du parent");
        }
    };
    ...
    const handleParentSubmit = async () => {
        try {
            if (!parentData.nom || !parentData.prenom || !parentData.tel || !parentData.mail || !parentData.ville || !parentData.etudiant_id) {
    ...
    const columns = [
        ...
        },
        {
            ...
            onFilter: (value, record) => record.prenom.toLowerCase().includes(value.toLowerCase()),
            filterIcon: (filtered) => <SearchOutlined style={{ color: filtered ? '#1890ff' : undefined }} />,
        },
        {
            title: "Téléphone",
        ...
        },
        {
            ...
            dataIndex: "nom_ville",
            key: "nom_ville",
            filters: cities.map(city => ({ text: city.nom_ville, value: city.nom_ville })),
                    ...
                    <Form layout="vertical">
                            ...
                            <Col span={12}>
                                <Form.Item label="Civilité" required>
                                    <Select
                                        ...
                                        onChange={(value) => setParentData({ ...parentData, civilite: value })}
                                    >
                                        <Select.Option value="Monsieur">Monsieur</Select.Option>
                                        <Select.Option value="Madame">Madame</Select.Option>
                                    </Select>
                            ...
                            <Col span={12}>
                                <Form.Item label="Adresse">
                                    <Input
                                        ...
                                        onChange={(e) => setParentData({ ...parentData, adresse: e.target.value })}
                                    />
                                </Form.Item>
                            </Col>
                        </Row>
                            ...
                            <Col span={12}>
                                <Form.Item label="Téléphone" required>
                                    <Input
                                        ...
                                        onChange={(e) => setParentData({ ...parentData, tel: e.target.value })}
                                    />
                                </Form.Item>
                            </Col>
                            <Col span={12}>
                                <Form.Item label="Email" required>
                                    <Input
                                        ...
                                        onChange={(e) => setParentData({ ...parentData, mail: e.target.value })}
                                    />
                                </Form.Item>
                            </Col>
                        </Row>
                            ...
                            <Col span={12}>
                                <Form.Item label="CIN">
                                    <Input
                                        ...
                                        onChange={(e) => setParentData({ ...parentData, cin: e.target.value })}
                                    />
                                </Form.Item>
                            </Col>
                            <Col span={12}>
                                <Form.Item label="Ville" required>
                                    <Select
                                        ...
                                        onChange={(value) => setParentData({ ...parentData, ville: value })}
                                    >
                                        {cities.map((city) => (
                                            <Select.Option key={city.id} value={city.id}>
                                                {city.nom_ville}
                        ...
                        >
                            <Select
                                ...
                                onChange={(value) => setParentData({ ...parentData, etudiant_id: value })}
                            >
